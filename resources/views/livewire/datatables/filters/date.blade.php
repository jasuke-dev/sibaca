<div x-data class="flex flex-col">
    <div class="w-full relative flex">
        <input x-ref="start" class="text-gray-400 w-full py-2 pl-1 pr-8 m-1 text-sm leading-4 block rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 dark:text-gray-100 dark:bg-gray-700" type="date"
    ...
    <div class="w-full relative flex items-center dark:bg-gray-400">
