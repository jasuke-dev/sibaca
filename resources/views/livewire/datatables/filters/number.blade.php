<div class="flex flex-col">
    <div x-data class="relative flex">
        <input
            ...
            class="dark:bg-gray-700 dark:text-gray-100 w-full py-2 pl-1 pr-8 m-1 text-sm leading-4 block rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
            placeholder="{{ __('MIN') }}"
        />
