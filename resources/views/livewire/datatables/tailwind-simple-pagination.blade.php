...
<div class="w-32 flex justify-between items-center relative px-4 py-2 border border-gray-300 text-sm leading-5 font-medium rounded-md text-gray-400 bg-gray-50 dark:bg-gray-800 dark:text-gray-100">
    <x-icons.arrow-left />
    {{ __('Previous')}}
</div>
@else
