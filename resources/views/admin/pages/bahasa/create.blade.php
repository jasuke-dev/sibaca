...
@section('container')
    <main class="h-full pb-16 overflow-y-auto">
        ...
        {{-- form --}}
        <form action="/admin/bahasa" method="POST">
            @csrf
            <div class="mx-8 px-8 py-4 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                <label for="type" class="block mt-4 text-sm">
                    ...
                    <input type="text" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Bahasa" name="bahasa" value="{{ old('bahasa') }}" required>
                    @error('type')
