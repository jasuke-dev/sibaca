    ...
    <main class="h-full pb-16 overflow-y-auto">
        <div class="container grid px-4 mx-auto">
            <div class="flex justify-between items-center py-3">
                ...
                {{-- add button --}}
                <a class="w-2/12 flex items-end justify-between p-4 text-sm font-semibold text-purple-100 bg-purple-600 rounded-lg shadow-md focus:outline-none focus:shadow-outline-purple" href="type/create">
