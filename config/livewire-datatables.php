...
return [
    ...
    */
    ...
    'default_classes' => [
        'row' => [
            'even' => 'divide-x divide-gray-100 text-sm text-gray-900 bg-gray-50 dark:bg-gray-800',
            'odd' => 'divide-x divide-gray-100 text-sm text-gray-900 bg-gray-50 dark:bg-gray-800',
            'selected' => 'divide-x divide-gray-100 text-sm text-gray-900 bg-yellow-100',
        ],
        'cell' => 'text-sm text-gray-900 dark:text-gray-100 border-none',
    ],
];
